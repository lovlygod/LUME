...
- `GET /messages/:userId` — стория переписки
...
- `ping` — Heartbeat
- `typing:start` / `typing:stop` — ндикатор набора
